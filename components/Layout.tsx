...
import { cls } from "../libs/cliebt/urils";
...
export default function Layout(props: LayoutProps) {
  ...
  return (
    <div className="flex justify-center bg-[#F6FAFD] text-[#133645] dark:bg-[#1E1E20] dark:text-[#E8E7E9]">
      <div className="border-2 border-blue-200 h-[100vh] w-[640px] flex flex-col justify-between">
        <header className="h-[100px]  flex justify-center items-center relative border-b-2 shadow-md">
          ...
          <div
            className="absolute right-8 cursor-pointer hover:bg-slate-300 rounded-2xl p-3"
            onClick={다크모드}
          >
            <svg
